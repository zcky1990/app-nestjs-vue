import Input from "../../src/frontend/components/InputComponent.vue";
...
export const InputWithNumberAsType = {
  parameters: {
    docs: {
      description: {
        story: "An input component example with Number as the input type.",
      },
      source: {
        code: `<Input v-model:value="value" input-label="Number" input-type="number" v-model:show-error="false" input-error-label="Example error message" />`
      },
    },
  },
  args: {
...
export const InputWithNumberAsTypeWithError = {
  parameters: {
    docs: {
      description: {
        story: "An input component example with Number as the input type and showing an error message.",
      },
      source: {
        code: `<Input v-model:value="value" input-label="Number" input-type="number" v-model:show-error="true" input-error-label="Example error message" />`
      },
    },
  },
  args: {
...
export const InputWithTelAsType = {
  parameters: {
    docs: {
      description: {
        story: "An input component example with Tel as the input type.",
      },
      source: {
        code: `<Input v-model:value="value" input-label="Tel" input-type="tel" v-model:show-error="false" input-error-label="Example error message" />`
      },
    },
  },
  args: {
...
export const InputWithTelAsTypeWithError = {
  parameters: {
    docs: {
      description: {
        story: "An input component example with Tel as the input type and showing an error message.",
      },
      source: {
        code: `<Input v-model:value="value" input-label="Tel" input-type="tel" v-model:show-error="true" input-error-label="Example error message" />`
      },
    },
  },
  args: {
